  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className={`max-w-4xl mx-auto transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-16 scale-95'
          }`} style={{
          ...
          <div className="relative bg-gradient-to-br from-slate-50 to-gray-50 rounded-2xl p-8 overflow-hidden shadow-lg">
            ...
            <div className={`relative w-full h-96 mx-auto transition-all duration-800 ease-out ${mapLoaded ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
              }`} style={{
              ...
              {cities.map((city, index) => (
                <div
                  key={index}
                  className={`absolute transform -translate-x-1/2 -translate-y-1/2 group cursor-pointer transition-all duration-700 ease-out ${mapLoaded
              ...
              <div className={`absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-lg p-3 shadow-md transition-all duration-800 ease-out ${mapLoaded
            ...
            {/* Service Areas List */}
            <div className={`mt-8 grid grid-cols-2 md:grid-cols-3 gap-4 transition-all duration-800 ease-out ${isVisible
              ...
              {cities.map((city, index) => (
                <div
                  key={index}
                  className={`flex items-center gap-2 text-gray-700 transition-all duration-600 ease-out ${isVisible
            ...
            {/* CTA */}
            <div className={`text-center mt-8 transition-all duration-800 ease-out ${isVisible
