...
const Stats: React.FC = () => {
  ...
  return (
    <section 
      ref={sectionRef}
      className={`py-20 relative overflow-hidden transition-all duration-1200 ease-out ${
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
          ...
          {stats.map((stat, index) => (
            ...
            >
              <div className={`bg-gradient-to-br ${stat.color} rounded-2xl p-8 mb-4 transform group-hover:scale-110 transition-all duration-500 shadow-xl hover:shadow-2xl`}>
                <div className={`text-4xl md:text-5xl font-bold text-white mb-2 transition-all duration-600 ${language === 'bn' ? 'font-bengali' : ''} ${
              ...
              <h3 className={`text-lg font-semibold text-lime-100 transition-all duration-600 ${language === 'bn' ? 'font-bengali' : ''} ${
        ...
        {/* Call to Action */}
        <div className={`text-center mt-16 transition-all duration-800 ease-out ${
