...
const Services: React.FC = () => {
  ...
  return (
    <section 
      ref={sectionRef}
      id="services" 
      className={`relative py-20 overflow-hidden transition-all duration-1200 ease-out ${
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6">
          ...
          {services.map((service, index) => (
            <div 
              key={index}
              className={`bg-white rounded-xl p-4 sm:p-6 shadow-sm hover:shadow-md transition-all duration-700 border border-gray-100 hover:border-emerald-200 group ${
                isVisible 
            ...
            >
              <div className={`w-12 h-12 sm:w-16 sm:h-16 rounded-lg border-2 flex items-center justify-center mb-3 sm:mb-4 group-hover:scale-110 transition-all duration-500 ${service.color} ${
              ...
              <h3 className={`text-lg sm:text-xl font-semibold text-gray-900 mb-2 transition-all duration-600 ${language === 'bn' ? 'font-bengali' : ''} ${
              ...
              <p className={`text-sm sm:text-base text-gray-600 transition-all duration-600 ${language === 'bn' ? 'font-bengali' : ''} ${
                isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-4'
              }`} style={{
              ...
              <div className={`mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-gray-100 transition-all duration-600 ${
